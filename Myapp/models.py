...
class DB_sql(models.Model):
    sql_name = models.CharField(max_length=20, null=True)  # 名字
    sql_des = models.CharField(max_length=50, null=True)
    Product = models.ForeignKey('Myapp.DB_project', on_delete=models.CASCADE, null=True)
    sql_content = models.CharField(max_length=200, null=True)  # 名字
    sql_db = models.ForeignKey('Myapp.DB_database', on_delete=models.CASCADE, null=True)


class DB_database(models.Model):
    db_name = models.CharField(max_length=20, null=True)  # 名字
    db_type = models.CharField(max_length=10, null=True)  # 名字
    db_host = models.CharField(max_length=20, null=True)
    db_port = models.IntegerField(max_length=10, null=True)
